...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'link': 'https://example.com.ner-recipe.pdf',
            'time_minutes': 10,
            'price': Decimal('2.50'),
        }
        url = detail_url(recipe.id)
    ...
    def test_delete_recipe_other_users_recipe_error(self):
        """test trying to delete other user recipe returns an error."""
    ...
    def test_create_recipe_with_new_tags(self):
        """Test creating a rcipe with new tags."""
        payload = {
           'title': 'Thai Curry',
           'time_minutes': 30,
           'price': Decimal('2.50'),
    ...
    def test_update_recipe_assign_tag(self):
        """test assigning an existing tag when updating a reecipe."""
    ...
    def test_update_recipe_assign_ingredients(self):
        """Test assigning an existing ingredient when ipdating a recipe."""
